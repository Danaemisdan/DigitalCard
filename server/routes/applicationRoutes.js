...
const { createApplication, getApplicationById, downloadCard, getAllApplications, extractOcrData, deleteApplication, finalizeApplication } = require('../controllers/applicationController');
